...
class RestaurantProvider extends ChangeNotifier {
  ...
  Future<void> getRestaurants() async {
   ...
   final favoriteProv = FavoriteProvider.instance(navigate.navigatorKey.currentContext!);
      if (result.error == false) {
        ...
        _restaurants
            ?.map((e) async => e.isFavorite = favoriteProv.isFavorite(e.id))
            .toList();
      } else {
        _restaurants = [];
      }
  ...
  void getRestaurant(String id) async {
    ...
    try {
      ...
      final favoriteProv =
          FavoriteProvider.instance(navigate.navigatorKey.currentContext!);
      if (result.error == false) {
  ...
  //   try {
  //     final result = await restaurantService.create(data);
  //     if (result.error == false) {
